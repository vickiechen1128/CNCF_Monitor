...
|------|------|----------|----------|----------|--------------|------|
| v1.2 | 2026-09-02 | 修改 | v0.2 范围收敛（2026-09-02 与产品负责人确认 v0.2 版本范围最终口径）：监控源 CRUD / 外部 Prometheus Remote Write / Ingestion Gateway / 标签注入整体由 v0.2 后移 v0.3（外联/异构接入需求优先级低）；v0.4（Zabbix / 云监控 Adapter）与 v1.0 范围不变 | 头部产品版本覆盖 | v0.3 | 设计中 |
