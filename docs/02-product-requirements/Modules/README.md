...
| Module_01 监控策略与指标管理 | v3.8 | v3.0 | ✅ 对齐 | 设计中 | MVP/v0.2/v0.3/v1.0 | #24 |
...
| Module_07 监控对象管理 | v2.9 | v2.5 | ✅ 对齐 | 设计中 | MVP/v0.4/v1.0 | #24 |
| Module_08 告警规则管理 | v1.2 | v1.1 | ⚠️ 原型待升级 | 设计中 | v0.3/v1.0 | #24 |
| Module_09 网域与边缘配置中心 | v1.28 | v1.21 | ✅ 对齐 | 设计中 | MVP/v0.2/v1.0 | #24 |
