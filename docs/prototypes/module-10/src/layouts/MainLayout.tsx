...
const currentTenant = { id: 'module-10', name: 'AIDC 运维租户', multi_site_enabled: true }
...
function buildMenu(): MenuItem[] {
  return [
    { key: '/monitoring-sources', icon: <AppstoreOutlined />, label: '监控源登记册' },
    { key: '/normalization', icon: <AppstoreOutlined />, label: '标签归一化' },
    { key: '/drop-rules', icon: <AppstoreOutlined />, label: '指标丢弃' },
  ]
}
