...
const currentTenant = { id: 'module-03', name: 'AIDC 运维租户', multi_site_enabled: true }
...
function buildMenu(): MenuItem[] {
  return [
    { key: '/gateway-routes', icon: <AppstoreOutlined />, label: '网关路由' },
    { key: '/auth-config', icon: <AppstoreOutlined />, label: '认证配置' },
  ]
}
