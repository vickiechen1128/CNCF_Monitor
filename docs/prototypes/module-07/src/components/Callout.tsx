...
/**
 * 统一提示容器（对齐《前端标准》§8 交互选型表；与 module-06 / module-09 同款视觉语言）。
 *
 * 背景：原型此前在「模块边界说明 / 空态 / 红线提示」处混用 Alert，风格与其它模块原型不一致。
 * 本组件统一为单块扁平容器：结构固定为「图标 + 标题 + 可选右侧操作 + 正文」，
 * 全页同款圆角 / 边框 / 内边距，信息一次给全，不再逐层点开。
 *
 * tone 取品牌四色：brand（引导）/ info（说明）/ warning（警示）/ success（确认）/ error（错误）。
 */
