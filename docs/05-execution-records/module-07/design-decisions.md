...
> v1.6 起主 PRD Change Log 精简为最近 3 版一句话摘要；本小节承载 v2.12 及以前的逐版完整变更详情（业务沟通决策记录）。2026-08-18 结构改造后，PRD 仅保留 v2.13-v2.15 最近 3 版，v2.7 / v2.8 / v2.9 / v2.10 / v2.11 / v2.12 本轮补迁入本表。
